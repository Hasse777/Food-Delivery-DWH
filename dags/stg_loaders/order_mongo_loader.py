...
class OrderMongoLoader:
    _LOG_THRESHOLD = 2
    _SESSION_LIMIT = 20000
    ...
    def run_copy(self) -> int:
        ...
        with self.pg_dest.connection() as conn:
            ...
            load_queue = self.collection_loader.get_info('orders', last_loaded_ts, self._SESSION_LIMIT)
            ...
            i = 0
            for d in load_queue:
                self.pg_saver.save_object(conn, 'stg.ordersystem_orders', str(d["_id"]), d["update_ts"], d)
