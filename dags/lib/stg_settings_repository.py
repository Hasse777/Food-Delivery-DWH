...
class StgEtlSettingsRepository:
    def get_setting(self, conn: Connection, etl_key: str, layer: str) -> Optional[EtlSetting]:
    ...
    def save_setting(self, conn: Connection, workflow_key: str, workflow_settings: str, layer: str) -> None:
        with conn.cursor() as cur:
            cur.execute(
                f"""
                    INSERT INTO {layer}.srv_wf_settings(workflow_key, workflow_settings)
